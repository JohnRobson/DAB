...
# -*- coding: utf-8 -*-
#
# DAB documentation build configuration file, created by
...
latex_documents = [
    (master_doc, 'DAB.tex', 'DAB Documentation',
     'John Robson', 'manual'),
]
...
man_pages = [
    (master_doc, 'dab', 'DAB Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DAB', 'DAB Documentation',
     author, 'DAB', 'One line description of project.',
     'Miscellaneous'),
]
...
# pdf_documents = [('index', u'rst2pdf', u'DAB Tests', u'John Robson'), ]
